      ...
      <div className={styles.profile__container}>
        ...
        <div className={styles.profile__navigation}>
          <Link
            ...
            className={`${styles.profile__favorites} ${location.pathname === "/personal/favorites" && styles.active}`}
          >
            <svg
              width="24"
              height="24"
          ...
          <Link
            ...
            className={`${styles.profile__settings} ${location.pathname === "/personal/settings" && styles.active}`}
          >
            <svg
              width="16"
              height="21"
        ...
        {location.pathname === "/personal/favorites" ? (
          <FavoritesPage userData={favoriteFilms.data} />
        ) : null}
      </div>
    </section>
  );
