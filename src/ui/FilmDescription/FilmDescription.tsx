...
export const FilmDescription: FC<FilmDescriptionProps> = ({ movieData }) => {
  const formattedBudget = formatCurrency(
    movieData?.budget ? movieData.budget : null,
  );
        ...
        <ul className={styles.descr__list}>
          <li className={styles.descr__item}>
            <div className={styles.descr__left}>
              <span className={styles.item__left_text}>Язык оригинала</span>
          ...
          <li className={styles.descr__item}>
            <div className={styles.descr__left}>
              <span className={styles.item__left_text}>Бюджет</span>
              <span className={styles.item__dots}></span>
            </div>
            <span className={styles.item__right}>
          ...
          <li className={styles.descr__item}>
            <div className={styles.descr__left}>
              <span className={styles.item__left_text}>Выручка</span>
              <span className={styles.item__dots}></span>
            </div>
            <span className={styles.item__right}>
          ...
          <li className={styles.descr__item}>
            <div className={styles.descr__left}>
              <span className={styles.item__left_text}>Режиссёр</span>
              <span className={styles.item__dots}></span>
            </div>
            <span className={styles.item__right}>
          ...
          <li className={styles.descr__item}>
            <div className={styles.descr__left}>
              <span className={styles.item__left_text}>Продакшен</span>
              <span className={styles.item__dots}></span>
            </div>
            <span className={styles.item__right}>
          ...
          <li className={styles.descr__item}>
            <div className={styles.descr__left}>
              <span className={styles.item__left_text}>Награды</span>
              <span className={styles.item__dots}></span>
            </div>
            <span className={styles.item__right}>
              {movieData?.awardsSummary
