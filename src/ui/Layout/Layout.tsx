    ...
    <>
      <header className={styles.header}>
        <div className={styles.header__container}>
          ...
          <nav
            className={`${styles.header__nav} ${adaptiveListOpen ? styles.active : ""}`}
          >
            <ul className={styles.header__list}>
              <li className={styles.header__list_item}>
                <Link
                  to={"/"}
                  className={`${styles.header__nav_link} ${location.pathname === "/" || location.pathname.startsWith(`/movie/`) ? styles.active : ""}`}
                >
                  Главная
                </Link>
              </li>
              <li className={styles.header__list_item}>
                <Link
                  to={"/genres"}
                  className={`${styles.header__nav_link} ${location.pathname === "/genres" ? styles.active : ""}`}
                >
                  Жанры
                </Link>
              </li>
          ...
          <button
            ...
            onClick={() => setAdaptiveListOpen(!adaptiveListOpen)}
          >
          ...
          {userData && userData.name ? (
            <Link
              ...
              className={`${styles.header__login} ${(location.pathname === "/personal/settings" || location.pathname === "/personal/favorites") && styles.active}`}
            >
              {isMobile ? (
                <svg
                  width="24"
            ...
            <Link to={"#"} className={styles.header__login} onClick={openModal}>
              Войти
            </Link>
          )}
        </div>
